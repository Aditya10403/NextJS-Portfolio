...
const Footer = () => {
  return (
    <footer className="w-full pt-20 mb-6" id="contact">
      {/* background grid */}
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Let&apos;s connect today and explore how I can help you reach your
          goals.
        </p>
        <div className="flex flex-col md:flex-row gap-y-6 md:gap-x-10">
          <a href="mailto:adityashukla2021@gmail.com">
            <MagicButton
